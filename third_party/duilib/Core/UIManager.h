...
public:
    ...
    // Add by Clouderman. 2013-1-9 9:26:17
	  static const CDuiString& GetStringTableZip();
	  static HANDLE GetStringTableZipHandle();
    // Add by Nicolas Chow. 2014-12-5 17:00:00
    static bool IsForceUseLocalResourceXml();
    static bool IsForceUseLocalResourceImage();
    ...
    // Add by Clouderman. 2013-1-9 9:29:58
	  static void SetStringTableZip(LPVOID pVoid, unsigned int len);
	  static void SetStringTableZip(LPCTSTR pstrZip);
    // Add by Nicolas Chow. 2014-12-5 17:00:00
    static void SetForceUseLocalResourceFile(bool image, bool xml, bool string_table);
	...
	// Add by Clouderman. 2013-1-9 10:41:29
	CDuiString GetStringTableXml();
	void SetStringTableXml(LPCTSTR pstrLanguageXml);
...
private:
    ...
    // Add by Clouderman. 2013-1-9 9:22:26
    static CDuiString m_strStringTableZip;
    static HANDLE m_hStringTableZip;
    CDuiString m_strStringTableXml;

    // Add by Nicolas Chow. 2014-12-5 17:00:00
    static bool m_bForceUseLocalResourceXml;
    static bool m_bForceUseLocalResourceImage;
    static bool m_bForceUseLocalResourceStringTable;
};
